...
namespace stk
{
	...
	class user_theme
	{
		...
		public:
			...
			color outline_color_normal() const { return outline_color_normal_; }
			color outline_color_focused() const { return outline_color_focused_; }
			...
			color fill_color_pressed() const { return fill_color_pressed_; }

			color font_color_normal() const { return font_color_normal_; }
			color font_color_focused() const { return font_color_focused_; }
			color font_color_hover() const { return font_color_hover_; }
			color font_color_pressed() const { return font_color_pressed_; }
