...
namespace stk
{
    ...
    public:
        ...
        /// draw the current drawable on the passed surface within the clip_rect
        /// Every concrete drawable can assume that the surface offset and clip_rect is set
        /// appropriately prior to this method being called.  (See container::draw())
