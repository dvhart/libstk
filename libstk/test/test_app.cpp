...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        INFO("test_app - selecting surface and event system");
        ...
        INFO("test_app - creating buttons, binding F1-F4");
        ...
        INFO("test_app - creating a progress bar");
        ...
        INFO("test_app - creating an image_panel in a scroll panel");
        ...
        // create a list
        INFO("test_app - creating a list with items");
        ...
        // create a spinner
        INFO("test_app - creating a spinner with items");
        ...
        // create an edit_box
        INFO("test_app - creating edit_box");
